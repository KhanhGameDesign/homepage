/*! For license information please see twig.min.js.LICENSE.txt */ ! function(e, t) {
    ...
    return function(e) {
        ...
        e.exports = function() {
            var e = /%%|%(?:(\d+)\$)?((?:[-+#0 ]|'[\s\S])*)(\d+)?(?:\.(\d*))?([\s\S])/g,
                ...
                i = function(e, t, r, n, i) {
                    var s = n - e.length;
                    return s > 0 && (e = r || "0" !== i ? o(e, n, i, r) : [e.slice(0, t.length), o("", s, "0", !0), e.slice(t.length)].join("")), e
                },
                s = function(e, t, r, n, s, a) {
                    return e = o((e >>> 0).toString(t), s || 0, "0", !1), i(e, "", r, n, a)
                },
                a = function(e, t, r, n, o) {
                    return null != n && (e = e.slice(0, n)), i(e, "", t, r, o)
                },
                c = function(e, n, c, p, l, u) {
                    var f, h, y, d, m;
                    if ("%%" === e) return "%";
                    var g, x, b = " ",
                        v = !1,
                        w = "";
                    for (g = 0, x = c.length; g < x; g++) switch (c.charAt(g)) {
                        case " ":
                        case "0":
                            b = c.charAt(g);
                            break;
                        ...
                        case "-":
                            ...
                            break;
                        case "'":
                            g + 1 < x && (b = c.charAt(g + 1), g++)
                    }
                    if (p = p ? +p : 0, !isFinite(p)) throw new Error("Width must be finite");
                    if (l = l ? +l : "d" === u ? 0 : "fFeE".indexOf(u) > -1 ? 6 : void 0, n && 0 == +n) throw new Error("Argument number must be greater than zero");
                    if (n && +n >= t.length) throw new Error("Too few arguments");
                    switch (m = n ? t[+n] : t[r++], u) {
                        case "%":
                            return "%";
                        case "s":
                            return a(m + "", v, p, l, b);
                        case "c":
                            return a(String.fromCharCode(+m), v, p, l, b);
                        case "b":
                            return s(m, 2, v, p, l, b);
                        case "o":
                            return s(m, 8, v, p, l, b);
                        case "x":
                            return s(m, 16, v, p, l, b);
                        case "X":
                            return s(m, 16, v, p, l, b).toUpperCase();
                        case "u":
                            return s(m, 10, v, p, l, b);
                        case "i":
                        case "d":
                            return f = +m || 0, m = (h = (f = Math.round(f - f % 1)) < 0 ? "-" : w) + o(String(Math.abs(f)), l, "0", !1), v && "0" === b && (b = " "), i(m, h, v, p, b);
                        case "e":
                        case "E":
                        case "f":
                        case "F":
                        case "g":
                        case "G":
                            return h = (f = +m) < 0 ? "-" : w, y = ["toExponential", "toFixed", "toPrecision"]["efg".indexOf(u.toLowerCase())], d = ["toString", "toUpperCase"]["eEfFgG".indexOf(u) % 2], m = h + Math.abs(f)[y](l), i(m, h, v, p, b)[d]();
                        default:
                            return ""
                    }
                };
        ...
        (function(e) {
            ...
            t.resolve = function() {
                ...
                for (var t = -1, r = 0, n = -1, o = !0, i = 0, s = e.length - 1; s >= 0; --s) {
                    ...
                    if (47 !== a) - 1 === n && (o = !1, n = s + 1), 46 === a ? -1 === t ? t = s : 1 !== i && (i = 1) : -1 !== t && (i = -1);
                    else if (!o) {
                        r = s + 1;
                        break
                    }
        ...
        e.exports = function e() {
            ...
            return r(9)(t), r(10)(t), r(11)(t), r(18)(t), r(19)(t), r(20)(t), r(31)(t), r(32)(t), r(35)(t), r(36)(t), r(37)(t), r(38)(t), r(39)(t), r(40)(t), r(41)(t), t.exports.factory = e, t.exports
        }
    }, function(e, t, r) {
        "use strict";
        var n = r(0)(r(2));
        ...
        e.exports = function(e) {
            function t(t, r) {
                if (t.template.options.rethrow) throw "string" == typeof r && (r = new e.Error(r)), "TwigException" !== r.type || r.file || (r.file = t.template.id), r;
                if (e.log.error("Error parsing twig template " + t.template.id + ": "), r.stack ? e.log.error(r.stack) : e.log.error(r.toString()), e.debug) return r.toString()
            }
            return e.trace = !1, e.debug = !1, e.cache = !0, e.noop = function() {}, e.merge = function(e, t, r) {
                ...
                trace: function() {
                    if (e.trace && console) {
                        ...
                        console.log(Array.prototype.slice.call(r))
                    }
                },
                debug: function() {
                    if (e.debug && console) {
                ...
                for (r = 0; r < c; r++) n = e.token.definitions[r], o = t.indexOf(n.open), i = t.indexOf(n.close), e.log.trace("Twig.token.findStart: ", "Searching for ", n.open, " found at ", o), o >= 0 && n.open.length !== n.close.length && i < 0 || (o >= 0 && (null === s.position || o < s.position) ? (s.position = o, s.def = n, a = i) : o >= 0 && null !== s.position && o === s.position && (n.open.length > s.def.open.length ? (s.position = o, s.def = n, a = i) : n.open.length === s.def.open.length && (n.close.length, s.def.close.length, i >= 0 && i < a && (s.position = o, s.def = n, a = i))));
                return s
            }, e.token.findEnd = function(t, r, n) {
                for (var o, i, s = null, a = !1, c = 0, p = null, l = null, u = null, f = null, h = null, y = null; !a;) {
                    if (p = null, l = null, !((u = t.indexOf(r.close, c)) >= 0)) throw new e.Error("Unable to find closing bracket '" + r.close + "' opened near template position " + n);
                    if (s = u, a = !0, r.type === e.token.type.comment) break;
                    if (r.type === e.token.type.raw) break;
                    for (i = e.token.strings.length, o = 0; o < i; o += 1)(h = t.indexOf(e.token.strings[o], c)) > 0 && h < u && (null === p || h < p) && (p = h, l = e.token.strings[o]);
                    if (null !== p)
                        for (f = p + 1, s = null, a = !1;;) {
                            if ((y = t.indexOf(l, f)) < 0) throw e.Error("Unclosed string in template");
                            if ("\\" !== t.slice(y - 1, y)) {
                                c = y + 1;
                                break
                            }
                ...
                for (var r = [], n = 0, o = null, i = null; t.length > 0;)
                    if (o = e.token.findStart(t), e.log.trace("Twig.tokenize: ", "Found token: ", o), null === o.position) r.push({
                        type: e.token.type.raw,
                        value: t
                    }), t = "";
                    else {
                        if (o.position > 0 && r.push({
                                type: e.token.type.raw,
                                value: t.slice(0, Math.max(0, o.position))
                            }), t = t.slice(o.position + o.def.open.length), n += o.position + o.def.open.length, i = e.token.findEnd(t, o.def, n), e.log.trace("Twig.tokenize: ", "Token ends at ", i), r.push({
                                type: o.def.type,
                                value: t.slice(0, Math.max(0, i)).trim()
                            }), "\n" === t.slice(i + o.def.close.length, i + o.def.close.length + 1)) switch (o.def.type) {
                        ...
                        t = t.slice(i + o.def.close.length), n += i + o.def.close.length
                    }
                return r
            }, e.compile = function(t) {
                var r = this;
                try {
                    for (var n = [], o = [], i = [], s = null, a = null, c = null, p = null, l = null, u = null, f = null, h = null, y = null, d = null, m = null, g = function(t) {
                            e.expression.compile.call(r, t), o.length > 0 ? i.push(t) : n.push(t)
                        }, x = function(t) {
                            if (a = e.logic.compile.call(r, t), y = a.type, d = e.logic.handler[y].open, m = e.logic.handler[y].next, e.log.trace("Twig.compile: ", "Compiled logic token to ", a, " next is: ", m, " open is : ", d), void 0 !== d && !d) {
                                if (p = o.pop(), !e.logic.handler[p.type].next.includes(y)) throw new Error(y + " not expected after a " + p.type);
                                p.output = p.output || [], p.output = p.output.concat(i), i = [], h = {
                                    type: e.token.type.logic,
                                    token: p
                                }, o.length > 0 ? i.push(h) : n.push(h)
                            }
                            void 0 !== m && m.length > 0 ? (e.log.trace("Twig.compile: ", "Pushing ", a, " to logic stack."), o.length > 0 && ((p = o.pop()).output = p.output || [], p.output = p.output.concat(i), o.push(p), i = []), o.push(a)) : void 0 !== d && d && (h = {
                                type: e.token.type.logic,
                                token: a
                            }, o.length > 0 ? i.push(h) : n.push(h))
                        }; t.length > 0;) {
                        switch (s = t.shift(), l = n[n.length - 1], u = i[i.length - 1], f = t[0], e.log.trace("Compiling token ", s), s.type) {
                            ...
                            case e.token.type.outputWhitespaceBoth:
                                switch (s.type !== e.token.type.outputWhitespacePost && s.type !== e.token.type.logicWhitespacePost && (l && l.type === e.token.type.raw && (n.pop(), l.value = l.value.trimEnd(), n.push(l)), u && u.type === e.token.type.raw && (i.pop(), u.value = u.value.trimEnd(), i.push(u))), s.type) {
                                    case e.token.type.outputWhitespacePre:
                                    case e.token.type.outputWhitespacePost:
                                    case e.token.type.outputWhitespaceBoth:
                                        g.call(r, s);
                                ...
                                s.type !== e.token.type.outputWhitespacePre && s.type !== e.token.type.logicWhitespacePre && f && f.type === e.token.type.raw && (t.shift(), f.value = f.value.trimStart(), t.unshift(f))
                        }
                ...
                var r = e.tokenize.call(this, t);
                e.log.debug("Twig.prepare: ", "Compiling ", r);
                var n = e.compile.call(this, r);
                return e.log.debug("Twig.prepare: ", "Compiled ", n), n
            }, e.output = function(t) {
                var r = this.options.autoescape;
                if (!r) return t.join("");
                var n = "string" == typeof r ? r : "html",
                    o = t.map((function(t) {
                        return !t || !0 === t.twigMarkup || t.twigMarkup === n || "html" === n && "html_attr" === t.twigMarkup || (t = e.filters.escape(t, [n])), t
                    }));
            ...
            }, e.Block.prototype.render = function(t, r) {
                var n = t.template;
                return t.template = this.template, (this.token.expression ? e.expression.parseAsync.call(t, this.token.output, r) : t.parseAsync(this.token.output, r)).then((function(n) {
                    return e.expression.parseAsync.call(t, {
                        type: e.expression.type.string,
                        value: n
                    }, r)
                })).then((function(e) {
                    return t.template = n, e
                }))
                ...
                var r;
                return !0 !== t && (r = this.overrideBlocks[e]), void 0 === r && (r = this.template.getBlock(e, t)), void 0 === r && null !== this.template.parentTemplate && (r = this.template.parentTemplate.getBlock(e)), r
                ...
                var t;
                return this.nestingStack.forEach((function(r) {
                    void 0 === t && r.type === e && (t = r)
                })), t
            }, e.ParseState.prototype.parse = function(r, n, o) {
                var i, s = this,
                    a = [],
                    c = null,
                    p = !0,
                ...
                if (n && (s.context = n), i = e.async.forEach(r, (function(t) {
                        switch (e.log.debug("Twig.ParseState.parse: ", "Parsing token: ", t), t.type) {
                            case e.token.type.raw:
                                a.push(e.filters.raw(t.value));
                                break;
                            case e.token.type.logic:
                                return e.logic.parseAsync.call(s, t.token, s.context, l).then(f);
                            case e.token.type.comment:
                                break;
                            case e.token.type.outputWhitespacePre:
                            case e.token.type.outputWhitespacePost:
                ...
                this.base = a, this.blocks = {
                    defined: {},
                    imported: {}
                }, this.id = s, this.method = u, this.name = l, this.options = f, this.parentTemplate = null, this.path = c, this.url = p, r = "String", n = i, o = Object.prototype.toString.call(n).slice(8, -1), this.tokens = null != n && o === r ? e.prepare.call(this, i) : i, void 0 !== s && e.Templates.save(this)
            }, e.Template.prototype.getBlock = function(e, t) {
                var r, n = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2];
                return !0 !== t && (r = this.blocks.defined[e]), n && void 0 === r && (r = this.blocks.imported[e]), void 0 === r && null !== this.parentTemplate && (r = this.parentTemplate.getBlock(e, t, n = !1)), r
                ...
                var o = this;
                return r = r || {}, e.async.potentiallyAsync(o, n, (function() {
                    var n = new e.ParseState(o, r.blocks);
                    return n.parseAsync(o.tokens, t).then((function(t) {
                        var i, s;
                        return null !== o.parentTemplate ? (o.options.allowInlineIncludes && (i = e.Templates.load(o.parentTemplate)) && (i.options = o.options), i || (s = e.path.parsePath(o, o.parentTemplate), i = e.Templates.loadRemote(s, {
                            method: o.getLoaderMethod(),
                            base: o.base,
                            async: !1,
                            id: s,
                            options: o.options
                        })), o.parentTemplate = i, o.parentTemplate.renderAsync(n.context, {
                            blocks: n.getBlocks(!1),
                            isInclude: !0
                        })) : !0 === r.isInclude ? t : t.valueOf()
                    }))
                }))
                ...
                var r = new String(e);
                return r.twigMarkup = void 0 === t || t, r
            }, e
        }
    }, function(e, t, r) {
        "use strict";
        e.exports = function(e) {
            return e.compiler = {
                ...
                var n = JSON.stringify(t.tokens),
                    o = t.id,
                    i = null;
                if (r.module) {
                    if (void 0 === e.compiler.module[r.module]) throw new e.Error("Unable to find module type " + r.module);
                    i = e.compiler.module[r.module](o, n, r.twig)
                } else i = e.compiler.wrap(o, n);
                return i
            }, e.compiler.module = {
                amd: function(t, r, n) {
        ...
        e.exports = function(e) {
            ...
            for (e.expression = {}, r(17)(e), e.expression.reservedWords = ["true", "false", "null", "TRUE", "FALSE", "NULL", "_context", "and", "b-and", "or", "b-or", "b-xor", "in", "not in", "if", "matches", "starts", "ends", "with"], e.expression.type = {
                    ...
                    compile: function(t, r, n) {
                        var o, i = t;
                        for (o = r.pop(); r.length > 0 && o.type !== e.expression.type.subexpression.start;) n.push(o), o = r.pop();
                        for (var s = []; t.type !== e.expression.type.subexpression.start;) s.unshift(t), t = n.pop();
                    ...
                    validate: function(t, r) {
                        var n = r[r.length - 1];
                        return n && !e.expression.reservedWords.includes(n.value.trim())
                    },
                    ...
                    compile: function(t, r, n) {
                        ...
                        for (var s = []; t.type !== e.expression.type.parameter.start;) s.unshift(t), t = n.pop();
                    ...
                    compile: function(e, t, r) {
                        var n = e.match[1].split(":"),
                            o = n[0] ? parseInt(n[0], 10) : void 0,
                            i = n[1] ? parseInt(n[1], 10) : void 0;
                        e.value = "slice", e.params = [o, i], i || (e.params = [o]), r.push(e)
                    },
                    parse: function(t, r) {
                        var n = r.pop(),
                            o = t.params;
                        r.push(e.filter.call(this, t.value, n, o))
                    }
                }, {
                    ...
                    next: e.expression.set.operationsExtended,
                    compile: function(t, r, n) {
                        for (var o, i = r.length - 1; i >= 0 && (o = r.pop()).type !== e.expression.type.array.start; i--) n.push(o);
                        n.push(t)
                    },
                    parse: function(t, r) {
                        for (var n = [], o = !1, i = null; r.length > 0;) {
                            if ((i = r.pop()) && i.type && i.type === e.expression.type.array.start) {
                                o = !0;
                                break
                            }
                            n.unshift(i)
                    ...
                    next: e.expression.set.operationsExtended,
                    compile: function(t, r, n) {
                        for (var o, i = r.length - 1; i >= 0 && (!(o = r.pop()) || o.type !== e.expression.type.object.start); i--) n.push(o);
                        n.push(t)
                    },
                    parse: function(t, r) {
                        for (var n = {}, o = !1, i = null, s = !1, a = null; r.length > 0;) {
                    ...
                    parse: function(r, n, o) {
                        var i = n.pop(),
                            s = this;
                        return t(s, r.params, o).then((function(t) {
                            return e.filter.call(s, r.value, i, t)
                        })).then((function(e) {
                            n.push(e)
                        }))
                    }
                    ...
                    parse: function(r, n, o) {
                        var s, a = this,
                            c = r.fn;
                        return t(a, r.params, o).then((function(t) {
                            if (e.functions[c]) s = e.functions[c].apply(a, t);
                            else {
                                if ("function" != typeof o[c]) throw new e.Error(c + " function does not exist and is not defined in the context");
                                s = o[c].apply(o, (0, i.default)(t))
                            }
                            return s
                        })).then((function(e) {
                            n.push(e)
                    ...
                    parse: function(t, r, n) {
                        var o = this;
                        return e.expression.resolveAsync.call(o, n[t.value], n).then((function(n) {
                            if (o.template.options.strictVariables && void 0 === n) throw new e.Error('Variable "' + t.value + '" does not exist.');
                            r.push(n)
                        }))
                    }
                }, {
                    ...
                    parse: function(r, n, i, s) {
                        ...
                        return t(c, r.params, i).then((function(t) {
                            if (null == l) a = void 0;
                            else {
                                var r = function(e) {
                                    return e.slice(0, 1).toUpperCase() + e.slice(1)
                                };
                                a = "object" === (0, o.default)(l) && p in l ? l[p] : l["get" + r(p)] ? l["get" + r(p)] : l["is" + r(p)] ? l["is" + r(p)] : void 0
                            }
                    ...
                    parse: function(r, n, i, s) {
                        var a, c, p = this,
                            l = null;
                        return t(p, r.params, i).then((function(t) {
                            return l = t, e.expression.parseAsync.call(p, r.stack, i)
                        })).then((function(t) {
                            if ((a = n.pop()) && !Object.prototype.hasOwnProperty.call(a, t) && p.template.options.strictVariables) {
                                var r = Object.keys(a);
                                throw r.length > 0 ? new e.Error('Key "' + t + '" for array with keys "' + r.join(", ") + '" does not exist.') : new e.Error('Key "' + t + '" does not exist as the array is empty.')
                            }
                            return null == a ? null : (c = "object" === (0, o.default)(a) && t in a ? a[t] : null, e.expression.resolveAsync.call(p, c, a, l, s))
                        })).then((function(e) {
                            n.push(e)
                        }))
                    }
                    ...
                    var a = e.Promise.resolve(n);
                    if (o && o.type === e.expression.type.parameter.end) {
                        a = a.then((function() {
                            return o.params && e.expression.parseAsync.call(s, o.params, r, !0)
                        })).then((function(e) {
            ...
            return e.expression.tokenize = function(t) {
                var r, n, o, i, s, a = [],
                    ...
                    u = function() {
                        ...
                        for (var u = arguments.length - 2, f = new Array(u); u-- > 0;) f[u] = n[u];
                        if (e.log.trace("Twig.expression.tokenize", "Matched a ", r, " regular expression of ", f), p && !p.includes(r)) return l.push(r + " cannot follow a " + a[a.length - 1].type + " at template:" + c + " near '" + f[0].slice(0, 20) + "...'"), f[0];
                        var h = e.expression.handler[r];
                        return h.validate && !h.validate(f, a) ? f[0] : (l = [], a.push({
                            type: r,
                            value: f[0],
                            match: f
                        }), s = !0, p = i, c += f[0].length, h.transform ? h.transform(f, a) : "")
                    };
                for (e.log.debug("Twig.expression.tokenize", "Tokenizing expression ", t); t.length > 0;) {
                    for (r in t = t.trim(), e.expression.handler)
                        if (Object.hasOwnProperty.call(e.expression.handler, r)) {
                            if (i = e.expression.handler[r].next, n = e.expression.handler[r].regex, e.log.trace("Checking type ", r, " on ", t), s = !1, Array.isArray(n))
                                for (o = n.length; o-- > 0;) t = t.replace(n[o], u);
                            else t = t.replace(n, u);
                            if (s) break
                        }
                ...
                var r = t.value,
                    ...
                    s = [],
                    a = null;
                for (e.log.trace("Twig.expression.compile: ", "Compiling ", r); n.length > 0;) o = n.shift(), a = e.expression.handler[o.type], e.log.trace("Twig.expression.compile: ", "Compiling ", o), a.compile(o, s, i), e.log.trace("Twig.expression.compile: ", "Stack is", s), e.log.trace("Twig.expression.compile: ", "Output is", i);
                ...
                return e.async.potentiallyAsync(i, o, (function() {
                    return e.async.forEach(t, (function(n, o) {
                        var p, l = null,
                            u = null;
                        if (!n.cleanup) return t.length > o + 1 && (u = t[o + 1]), (l = e.expression.handler[n.type]).parse && (p = l.parse.call(i, n, s, r, u)), n.type === c && r.loop && a.push(n), p
                    })).then((function() {
        ...
        e.exports = function(e) {
            ...
            var t = function(e, t) {
                ...
                var r;
                for (r in t)
                    if (Object.hasOwnProperty.call(t, r) && t[r] === e) return !0;
                return !1
            };
            return e.expression.operator.lookup = function(t, r) {
                switch (t) {
                    ...
                    case ":":
                        ...
                        break;
                    case "??":
                        r.precidence = 15, r.associativity = e.expression.operator.rightToLeft;
                        break;
                    case "or":
                ...
                var o, i, s;
                if (e.log.trace("Twig.expression.operator.parse: ", "Handling ", r), "?" === r && (s = n.pop()), i = n.pop(), "not" !== r && (o = n.pop()), "in" !== r && "not in" !== r && "??" !== r && (o && Array.isArray(o) && (o = o.length), "?" !== r && i && Array.isArray(i) && (i = i.length)), "matches" === r && i && "string" == typeof i) {
                    var a = i.match(/^\/(.*)\/([gims]?)$/),
                        c = a[1],
                        p = a[2];
                    i = new RegExp(c, p)
                ...
                switch (r) {
                    case ":":
                        break;
                    case "??":
                        void 0 === o && (o = i, i = s, s = void 0), null != o ? n.push(o) : n.push(i);
                        break;
                    case "?:":
                    ...
                    case "matches":
                        ...
                        break;
                    case "starts with":
                        n.push("string" == typeof o && 0 === o.indexOf(i));
                        break;
                    case "ends with":
                        n.push("string" == typeof o && o.includes(i, o.length - i.length));
                        break;
                    case "..":
            ...
            return e.filters = {
                ...
                sort: function(e) {
                    ...
                    if (t("Object", e)) {
                        ...
                        var r = Object.keys(e).sort((function(t, r) {
                            var n, o;
                            return e[t] > e[r] == !(e[t] <= e[r]) ? e[t] > e[r] ? 1 : e[t] < e[r] ? -1 : 0 : isNaN(n = parseFloat(e[t])) || isNaN(o = parseFloat(e[r])) ? "string" == typeof e[t] ? e[t] > e[r].toString() ? 1 : e[t] < e[r].toString() ? -1 : 0 : "string" == typeof e[r] ? e[t].toString() > e[r] ? 1 : e[t].toString() < e[r] ? -1 : 0 : null : n > o ? 1 : n < o ? -1 : 0
                        }));
                        return e._keys = r, e
                    }
                },
                keys: function(e) {
                    if (null != e) {
                        ...
                        return t.forEach((function(t) {
                            "_keys" !== t && Object.hasOwnProperty.call(e, t) && r.push(t)
                        })), r
                    }
                },
                    ...
                    if (null != t) {
                        if (e.lib.is("Object", t)) {
                            return function t(r, n) {
                                var o = [];
                                return (r._keys || Object.keys(r)).forEach((function(i) {
                                    if (Object.prototype.hasOwnProperty.call(r, i)) {
                                        var s = n ? n + "[" + i + "]" : i,
                                            a = r[i];
                                        o.push(e.lib.is("Object", a) || Array.isArray(a) ? t(a, s) : encodeURIComponent(s) + "=" + encodeURIComponent(a))
                                    }
                                })), o.join("&amp;")
                            }(t)
                        }
                ...
                join: function(e, r) {
                    if (null != e) {
                        var n = "",
                            o = [];
                        return r && r[0] && (n = r[0]), t("Array", e) ? o = e : (e._keys || Object.keys(e)).forEach((function(t) {
                            "_keys" !== t && Object.hasOwnProperty.call(e, t) && o.push(e[t])
                        })), o.join(n)
                    }
                },
                ...
                json_encode: function(r) {
                    ...
                    if ("object" === (0, n.default)(r) && t("Array", r)) {
                        var o = [];
                        return r.forEach((function(t) {
                            o.push(e.filters.json_encode(t))
                        })), "[" + o.join(",") + "]"
                    }
                    if ("object" === (0, n.default)(r) && t("Date", r)) return '"' + r.toISOString() + '"';
                    if ("object" === (0, n.default)(r)) {
                        var i = r._keys || Object.keys(r),
                            s = [];
                        return i.forEach((function(t) {
                            s.push(JSON.stringify(t) + ":" + e.filters.json_encode(r[t]))
                        })), "{" + s.join(",") + "}"
                    }
                ...
                merge: function(r, n) {
                    var o = [],
                        i = 0;
                    if (t("Array", r) ? n.forEach((function(e) {
                            t("Array", e) || (o = {})
                        })) : o = {}, t("Array", o) || (o._keys = []), t("Array", r) ? r.forEach((function(e) {
                            o._keys && o._keys.push(i), o[i] = e, i++
                        })) : (r._keys || Object.keys(r)).forEach((function(e) {
                ...
                date: function(t, r) {
                    var n = e.functions.date(t),
                        o = r && Boolean(r.length) ? r[0] : "F j, Y H:i";
                    return e.lib.date(o.replace(/\\\\/g, "\\"), n)
                },
                ...
                replace: function(t, r) {
                    if (null != t) {
                        var n, o = r[0];
                        for (n in o) Object.hasOwnProperty.call(o, n) && "_keys" !== n && (t = e.lib.replaceAll(t, n, o[n]));
                        return t
                    }
                },
                format: function(t, r) {
                ...
                striptags: function(t, r) {
                    if (null != t) return e.lib.stripTags(t, r)
                },
                escape: function(t, r) {
                    if (null != t && "" !== t) {
                        var n = "html";
                        if (r && Boolean(r.length) && !0 !== r[0] && (n = r[0]), "html" === n) {
                            var o = t.toString().replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#039;");
                            return new e.Markup(o, "html")
                        }
                        if ("js" === n) {
                        ...
                        if ("css" === n) {
                            for (var u = t.toString(), f = "", h = 0; h < u.length; h++) {
                                if (u[h].match(/^[a-zA-Z0-9]$/)) f += u[h];
                                else f += "\\" + u.charCodeAt(h).toString(16).toUpperCase() + " "
                            }
                            return new e.Markup(f, "css")
                        }
                        if ("url" === n) {
                            var y = e.filters.url_encode(t);
                            return new e.Markup(y, "url")
                        }
                        if ("html_attr" === n) {
                            for (var d = t.toString(), m = "", g = 0; g < d.length; g++)
                                if (d[g].match(/^[a-zA-Z0-9,.\-_]$/)) m += d[g];
                                else if (d[g].match(/^[&<>"]$/)) m += d[g].replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;");
                            else {
                                var x = d.charCodeAt(g);
                                m += x <= 31 && 9 !== x && 10 !== x && 13 !== x ? "&#xFFFD;" : x < 128 ? e.lib.sprintf("&#x%02s;", x.toString(16).toUpperCase()) : e.lib.sprintf("&#x%04s;", x.toString(16).toUpperCase())
                            }
                ...
                number_format: function(e, t) {
                    var r = e,
                        ...
                        o = t && void 0 !== t[1] ? t[1] : ".",
                        i = t && void 0 !== t[2] ? t[2] : ",";
                    r = String(r).replace(/[^0-9+\-Ee.]/g, "");
                    var s = isFinite(Number(r)) ? Number(r) : 0,
                        a = isFinite(Number(n)) ? Math.abs(n) : 0,
                        c = "";
                    return (c = (a ? function(e, t) {
                        var r = Math.pow(10, t);
                        return String(Math.round(e * r) / r)
                    }(s, a) : String(Math.round(s))).split("."))[0].length > 3 && (c[0] = c[0].replace(/\B(?=(?:\d{3})+(?!\d))/g, i)), (c[1] || "").length < a && (c[1] = c[1] || "", c[1] += new Array(a - c[1].length + 1).join("0")), c.join(o)
                },
                trim: function(e, t) {
                    if (null != e) {
                        var r, n = String(e);
                        ...
                        for (var o = 0; o < n.length; o++)
                            if (!r.includes(n.charAt(o))) {
                                n = n.slice(Math.max(0, o));
                                break
                            }
                        for (var i = n.length - 1; i >= 0; i--)
                            if (!r.includes(n.charAt(i))) {
                                n = n.slice(0, Math.max(0, i + 1));
                                break
                            }
                        return r.includes(n.charAt(0)) ? "" : n
                    }
                },
                truncate: function(e, t) {
                    var r = 30,
                        n = !1,
                        o = "...";
                    if (e = String(e), t && (t[0] && (r = t[0]), t[1] && (n = t[1]), t[2] && (o = t[2])), e.length > r) {
                ...
                slice: function(t, r) {
                    if (null != t) {
                        if (void 0 === r || 0 === r.length) throw new e.Error("slice filter expects at least 1 argument");
                        var n = r[0] || 0,
                            o = r.length > 1 ? r[1] : t.length,
                            i = n >= 0 ? n : Math.max(t.length + n, 0);
                        if (e.lib.is("Array", t)) {
                            for (var s = [], a = i; a < i + o && a < t.length; a++) s.push(t[a]);
                            return s
                        }
                        if (e.lib.is("String", t)) return t.slice(i, i + o);
                ...
                split: function(t, r) {
                    if (null != t) {
                        if (void 0 === r || 0 === r.length || r.length > 2) throw new e.Error("split filter expects 1 or 2 argument");
                        if (e.lib.is("String", t)) {
                            ...
                            if ("" === n)
                                for (; i.length > 0;) {
                                    for (var a = "", c = 0; c < o && i.length > 0; c++) a += i.shift();
                                    s.push(a)
                                } else {
                                    for (var p = 0; p < o - 1 && i.length > 0; p++) s.push(i.shift());
                ...
                last: function(t) {
                    var r;
                    return e.lib.is("Object", t) ? t[(r = void 0 === t._keys ? Object.keys(t) : t._keys)[r.length - 1]] : e.lib.is("Number", t) ? t.toString().slice(-1) : t[t.length - 1]
                },
                raw: function(t) {
                ...
                batch: function(t, r) {
                    ...
                    if (s && t.length % i != 0) {
                        for (o = i - (n = a.pop()).length; o--;) n.push(s);
                        a.push(n)
                    }
                    return a
                },
                ...
                return e.filters[t].call(this, r, n)
            ...
            return t.functions = {
                range: function(e, t, r) {
                    var n, o, i = [],
                        s = r || 1,
                        a = !1;
                    if (isNaN(e) || isNaN(t) ? isNaN(e) && isNaN(t) ? (a = !0, n = e.charCodeAt(0), o = t.charCodeAt(0)) : (n = isNaN(e) ? 0 : e, o = isNaN(t) ? 0 : t) : (n = parseInt(e, 10), o = parseInt(t, 10)), !(n > o))
                ...
                dump: function() {
                    ...
                    var o = [].concat(t),
                        ...
                        u = function(e) {
                            p += l(c), "object" === (0, n.default)(e) ? f(e) : "function" == typeof e ? p += "function()" + s : "string" == typeof e ? p += "string(" + e.length + ') "' + e + '"' + s : "number" == typeof e ? p += "number(" + e + ")" + s : "boolean" == typeof e && (p += "bool(" + e + ")" + s)
                        },
                        f = function(e) {
                            var t;
                            if (null === e) p += "NULL" + s;
                            else if (void 0 === e) p += "undefined" + s;
                            else if ("object" === (0, n.default)(e)) {
                                for (t in p += l(c) + (0, n.default)(e), c++, p += "(" + function(e) {
                                        var t, r = 0;
                                        for (t in e) Object.hasOwnProperty.call(e, t) && r++;
                                        return r
                                    }(e) + ") {" + s, e) Object.hasOwnProperty.call(e, t) && (p += l(c) + "[" + t + "]=> " + s, u(e[t]));
                                c--, p += l(c) + "}" + s
                            } else u(e)
                        };
                    return 0 === o.length && o.push(i.context), o.forEach((function(e) {
                        f(e)
                    })), p
                },
                date: function(e) {
                    ...
                    else if (t.lib.is("String", e)) r = e.match(/^\d+$/) ? new Date(1e3 * e) : new Date(1e3 * t.lib.strtotime(e));
                    else {
                ...
                attribute: function(e, r, n) {
                    return t.lib.is("Object", e) && Object.hasOwnProperty.call(e, r) ? "function" == typeof e[r] ? e[r].apply(void 0, n) : e[r] : e && e[r] || void 0
                },
                max: function(e) {
                    if (t.lib.is("Object", e)) return delete e._keys, t.lib.max(e);
                    for (var r = arguments.length, n = new Array(r > 1 ? r - 1 : 0), o = 1; o < r; o++) n[o - 1] = arguments[o];
                    return Reflect.apply(t.lib.max, null, [e].concat(n))
                },
                min: function(e) {
                    if (t.lib.is("Object", e)) return delete e._keys, t.lib.min(e);
                    for (var r = arguments.length, n = new Array(r > 1 ? r - 1 : 0), o = 1; o < r; o++) n[o - 1] = arguments[o];
                    return Reflect.apply(t.lib.min, null, [e].concat(n))
                },
                ...
                random: function(e) {
                    function r(e) {
                        ...
                        return r + Math.floor((n - r + 1) * t / 2147483648)
                    }
                ...
                source: function(r, n) {
                    ...
                    void 0 === n && (n = !1);
                    try {
                        null == (o = t.Templates.loadRemote(r, s)) ? o = "" : i = !0
                    } catch (e) {
                        t.log.debug("Twig.functions.source: ", "Problem loading template  ", e)
                    }
                    return i || n ? o : 'Template "{name}" is not defined.'.replace("{name}", r)
                }
        ...
        "use strict";
        e.exports = function(e) {
            return e.lib = {}, e.lib.sprintf = r(4), e.lib.vsprintf = r(21), e.lib.round = r(22), e.lib.max = r(24), e.lib.min = r(25), e.lib.stripTags = r(26), e.lib.strtotime = r(28), e.lib.date = r(29), e.lib.boolval = r(30), e.lib.is = function(e, t) {
                if (null == t) return !1;
                switch (e) {
                    case "Array":
        ...
        "use strict";
        e.exports = function(e, t) {
            return r(4).apply(this, [e].concat(t))
        }
    }, function(e, t, r) {
        "use strict";

        function n(e, t) {
            var r = Math.floor(Math.abs(e) + .5);
            return ("PHP_ROUND_HALF_DOWN" === t && e === r - .5 || "PHP_ROUND_HALF_EVEN" === t && e === .5 + 2 * Math.floor(r / 2) || "PHP_ROUND_HALF_ODD" === t && e === .5 + 2 * Math.floor(r / 2) - 1) && (r -= 1), e < 0 ? -r : r
        }
        e.exports = function(e) {
            var t, o = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
                ...
                s = r(23),
                a = r(5);
            if (e = s(e), o = a(o), t = Math.pow(10, o), isNaN(e) || !isFinite(e)) return e;
            if (Math.trunc(e) === e && o >= 0) return e;
            var c = 14 - Math.floor(Math.log10(Math.abs(e)));
            return c > o && c - 15 < o ? (e = n(e * Math.pow(10, c), i), e /= Math.pow(10, Math.abs(o - c))) : e *= t, (e = n(e, i)) / t
        }
    }, function(e, t, r) {
        "use strict";
        var n = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
        ...
        e.exports = function() {
                ...
                c = function e(t, r) {
                    ...
                    if ("object" === (void 0 === t ? "undefined" : n(t))) {
                        if ("object" === (void 0 === r ? "undefined" : n(r))) {
                            if (t = a(t), r = a(r), p = t.length, (c = r.length) > p) return 1;
                            if (c < p) return -1;
                            for (o = 0, i = p; o < i; ++o) {
            ...
            for (t = e[0], r = 1, o = e.length; r < o; ++r) 1 === c(t, e[r]) && (t = e[r]);
            return t
        }
    }, function(e, t, r) {
        "use strict";
        ...
        e.exports = function(e, t) {
            ...
            for (s = "<" === s.substring(s.length - 1) ? s.substring(0, s.length - 1) : s;;) {
                var a = s;
                if (s = a.replace(i, "").replace(o, (function(e, r) {
        ...
        var n = "(?:([ap])\\.?m\\.?([\\t ]|$))",
            ...
            f = u + "|sun|mon|tue|wed|thu|fri|sat|weekdays?",
            h = "first|second|third|fourth|fifth|sixth|seventh|eighth?|ninth|tenth|eleventh|twelfth",
            y = "(?:second|sec|minute|min|hour|day|fortnight|forthnight|month|year)s?|weeks|" + f,
            d = "([0-9]{1,4})",
            m = "([0-9]{4})",
            g = "(1[0-2]|0?[0-9])",
            x = "(0[0-9]|1[0-2])",
            b = "(?:(3[01]|[0-2]?[0-9])(?:st|nd|rd|th)?)",
            v = "(0[0-9]|[1-2][0-9]|3[01])",
            w = "january|february|march|april|may|june|july|august|september|october|november|december",
            k = "jan|feb|mar|apr|may|jun|jul|aug|sept?|oct|nov|dec",
            T = "(" + w + "|" + k + "|i[vx]|vi{0,3}|xi{0,2}|i{1,3})",
            S = "((?:GMT)?([+-])" + o + ":?" + a + "?)",
            E = T + "[ .\\t-]*" + b + "[,.stndrh\\t ]*";
        ...
        function _(e, t) {
            ...
            var r = "-" === e[1] ? 1 : -1,
                n = +e[2],
                o = +e[4];
            return e[4] || e[3] || (o = Math.floor(n % 100), n = Math.floor(n / 100)), r * (60 * n + o)
        }
        var P = {
                yesterday: {
                    regex: /^yesterday/i,
                ...
                backOrFrontOf: {
                    regex: RegExp("^(back|front) of " + o + "[ \\t]*" + n + "?", "i"),
                    name: "backof | frontof",
                    callback: function(e, t, r, n) {
                        var o = +r,
                            i = 15;
                        return "back" === t.toLowerCase() || (o -= 1, i = 45), o = A(o, n), this.resetTime() && this.time(o, i, 0, 0)
                    }
                },
                weekdayOf: {
                    regex: RegExp("^(" + h + "|next|last|previous|this)[ \\t]+(" + u + "|sun|mon|tue|wed|thu|fri|sat)[ \\t]+of", "i"),
                    name: "weekdayof"
                },
                mssqltime: {
                    regex: RegExp("^" + s + ":" + c + ":" + l + "[:.]([0-9]+)" + n, "i"),
                    name: "mssqltime",
                    callback: function(e, t, r, n, o, i) {
                        return this.time(A(+t, i), +r, +n, +o.substr(0, 3))
                    }
                },
                timeLong12: {
                    regex: RegExp("^" + s + "[:.]" + a + "[:.]" + l + "[ \\t]*" + n, "i"),
                    name: "timelong12",
                    callback: function(e, t, r, n, o) {
                        return this.time(A(+t, o), +r, +n, 0)
                    }
                },
                timeShort12: {
                    regex: RegExp("^" + s + "[:.]" + c + "[ \\t]*" + n, "i"),
                    name: "timeshort12",
                    callback: function(e, t, r, n) {
                        return this.time(A(+t, n), +r, 0, 0)
                    }
                },
                timeTiny12: {
                    regex: RegExp("^" + s + "[ \\t]*" + n, "i"),
                    ...
                    callback: function(e, t, r) {
                        return this.time(A(+t, r), 0, 0, 0)
                    }
                },
                soap: {
                    regex: RegExp("^" + m + "-" + x + "-" + v + "T" + i + ":" + c + ":" + l + "(?:\\.([0-9]+))" + S + "?", "i"),
                    name: "soap",
                    callback: function(e, t, r, n, o, i, s, a, c) {
                        return this.ymd(+t, r - 1, +n) && this.time(+o, +i, +s, +a.substr(0, 3)) && this.zone(_(c))
                    }
                },
                wddx: {
                    regex: RegExp("^" + m + "-" + g + "-" + b + "T" + o + ":" + a + ":" + p),
                    name: "wddx",
                    callback: function(e, t, r, n, o, i, s) {
                        return this.ymd(+t, r - 1, +n) && this.time(+o, +i, +s, 0)
                    }
                },
                exif: {
                    regex: RegExp("^" + m + ":" + x + ":" + v + " " + i + ":" + c + ":" + l, "i"),
                    name: "exif",
                    callback: function(e, t, r, n, o, i, s) {
                        return this.ymd(+t, r - 1, +n) && this.time(+o, +i, +s, 0)
                    }
                ...
                clf: {
                    regex: RegExp("^" + b + "/(" + k + ")/" + m + ":" + i + ":" + c + ":" + l + "[ \\t]+" + S, "i"),
                    name: "clf",
                    callback: function(e, t, r, n, o, i, s, a) {
                        return this.ymd(+n, O(r), +t) && this.time(+o, +i, +s, 0) && this.zone(_(a))
                    }
                },
                iso8601long: {
                    regex: RegExp("^t?" + o + "[:.]" + a + "[:.]" + p + "(?:\\.([0-9]+))", "i"),
                    name: "iso8601long",
                    callback: function(e, t, r, n, o) {
                        return this.time(+t, +r, +n, +o.substr(0, 3))
                    }
                },
                dateTextual: {
                    regex: RegExp("^" + T + "[ .\\t-]*" + b + "[,.stndrh\\t ]+" + d, "i"),
                    name: "datetextual",
                    callback: function(e, t, r, n) {
                        return this.ymd(j(n), O(t), +r)
                    }
                },
                pointedDate4: {
                    regex: RegExp("^" + b + "[.\\t-]" + g + "[.-]" + m),
                    name: "pointeddate4",
                    callback: function(e, t, r, n) {
                        return this.ymd(+n, r - 1, +t)
                    }
                },
                pointedDate2: {
                    regex: RegExp("^" + b + "[.\\t]" + g + "\\.([0-9]{2})"),
                    name: "pointeddate2",
                    callback: function(e, t, r, n) {
                        return this.ymd(j(n), r - 1, +t)
                    }
                },
                timeLong24: {
                    regex: RegExp("^t?" + o + "[:.]" + a + "[:.]" + p),
                    name: "timelong24",
                    callback: function(e, t, r, n) {
                        return this.time(+t, +r, +n, 0)
                    }
                },
                dateNoColon: {
                    regex: RegExp("^" + m + x + v),
                ...
                pgydotd: {
                    ...
                    name: "pgydotd",
                    callback: function(e, t, r) {
                        return this.ymd(+t, 0, +r)
                    }
                },
                timeShort24: {
                    regex: RegExp("^t?" + o + "[:.]" + a, "i"),
                    name: "timeshort24",
                    callback: function(e, t, r) {
                        return this.time(+t, +r, 0, 0)
                    }
                },
                iso8601noColon: {
                ...
                gnuDateShortOrIso8601date2: {
                    ...
                    callback: function(e, t, r, n) {
                        return this.ymd(j(t), r - 1, +n)
                    }
                },
                iso8601date4: {
                    regex: RegExp("^([+-]?[0-9]{4})-" + x + "-" + v),
                    name: "iso8601date4",
                    callback: function(e, t, r, n) {
                        return this.ymd(+t, r - 1, +n)
                    }
                ...
                gnuNoColon: {
                    ...
                    callback: function(e, t, r) {
                        switch (this.times) {
                            case 0:
                                return this.time(+t, +r, 0, this.f);
                            case 1:
                                return this.y = 100 * t + +r, this.times++, !0;
                            default:
                                return !1
                        }
                    }
                ...
                gnuDateShorter: {
                    ...
                    name: "gnudateshorter",
                    callback: function(e, t, r) {
                        return this.ymd(+t, r - 1, 1)
                    }
                },
                pgTextReverse: {
                    regex: RegExp("^(\\d{3,4}|[4-9]\\d|3[2-9])-(" + k + ")-" + v, "i"),
                    name: "pgtextreverse",
                    callback: function(e, t, r, n) {
                        return this.ymd(j(t), O(r), +n)
                    }
                },
                dateFull: {
                    regex: RegExp("^" + b + "[ \\t.-]*" + T + "[ \\t.-]*" + d, "i"),
                    name: "datefull",
                    callback: function(e, t, r, n) {
                        return this.ymd(j(n), O(r), +t)
                    }
                },
                dateNoDay: {
                    regex: RegExp("^" + T + "[ .\\t-]*" + m, "i"),
                ...
                dateNoDayRev: {
                    ...
                    name: "datenodayrev",
                    callback: function(e, t, r) {
                        return this.ymd(+t, O(r), 1)
                    }
                },
                pgTextShort: {
                    regex: RegExp("^(" + k + ")-" + v + "-" + d, "i"),
                    name: "pgtextshort",
                    callback: function(e, t, r, n) {
                        return this.ymd(j(n), O(t), +r)
                    }
                ...
                isoWeekDay: {
                    ...
                    callback: function(e, t, r, n) {
                        if (n = n ? +n : 1, !this.ymd(+t, 0, 1)) return !1;
                        var o = new Date(this.y, this.m, this.d).getDay();
                        o = 0 - (o > 4 ? o - 7 : o), this.rd += o + 7 * (r - 1) + n
                    }
                },
                relativeText: {
                    regex: RegExp("^(" + h + "|next|last|previous|this)[ \\t]+(" + y + ")", "i"),
                    name: "relativetext",
                    callback: function(e, t, r) {
                        var n, o = {
                                amount: {
                        ...
                        switch (r.toLowerCase()) {
                            ...
                            case "sun":
                            case "sunday":
                                this.resetTime(), this.weekday = N(r, 7), this.weekdayBehavior = 1, this.rd += 7 * (i > 0 ? i - 1 : i)
                        }
                    }
                },
                relative: {
                    regex: RegExp("^([+-]*)[ \\t]*(\\d+)[ \\t]*(" + y + "|week)", "i"),
                    name: "relative",
                    callback: function(e, t, r, n) {
                        var o = t.replace(/[^-]/g, "").length,
                            i = +r * Math.pow(-1, o);
                        switch (n.toLowerCase()) {
                            ...
                            case "sun":
                            case "sunday":
                                this.resetTime(), this.weekday = N(n, 7), this.weekdayBehavior = 1, this.rd += 7 * (i > 0 ? i - 1 : i)
                        }
                    }
                },
                dayText: {
                    ...
                    name: "daytext",
                    callback: function(e, t) {
                        this.resetTime(), this.weekday = N(t, 0), 2 !== this.weekdayBehavior && (this.weekdayBehavior = 1)
                    }
                },
                relativeTextWeek: {
                ...
                dateShortWithTimeLong: {
                    regex: RegExp("^" + E + "t?" + o + "[:.]" + a + "[:.]" + p, "i"),
                    name: "dateshortwithtimelong",
                    callback: function(e, t, r, n, o, i) {
                        return this.ymd(this.y, O(t), +r) && this.time(+n, +o, +i, 0)
                    }
                },
                dateShortWithTimeLong12: {
                    regex: RegExp("^" + E + s + "[:.]" + a + "[:.]" + l + "[ \\t]*" + n, "i"),
                    name: "dateshortwithtimelong12",
                    callback: function(e, t, r, n, o, i, s) {
                        return this.ymd(this.y, O(t), +r) && this.time(A(+n, s), +o, +i, 0)
                    }
                },
                dateShortWithTimeShort: {
                    regex: RegExp("^" + E + "t?" + o + "[:.]" + a, "i"),
                    name: "dateshortwithtimeshort",
                    callback: function(e, t, r, n, o) {
                        return this.ymd(this.y, O(t), +r) && this.time(+n, +o, 0, 0)
                    }
                },
                dateShortWithTimeShort12: {
                    regex: RegExp("^" + E + s + "[:.]" + c + "[ \\t]*" + n, "i"),
                    name: "dateshortwithtimeshort12",
                    callback: function(e, t, r, n, o, i) {
                        return this.ymd(this.y, O(t), +r) && this.time(A(+n, i), +o, 0, 0)
                    }
                }
            },
            R = {
                ...
                zones: 0,
                ymd: function(e, t, r) {
                    return !(this.dates > 0) && (this.dates++, this.y = e, this.m = t, this.d = r, !0)
                },
                time: function(e, t, r, n) {
                    return !(this.times > 0) && (this.times++, this.h = e, this.i = t, this.s = r, this.f = n, !0)
                },
                resetTime: function() {
                ...
                toDate: function(e) {
                    ...
                    if (!isNaN(this.weekday)) {
                        ...
                        var r = t.getDay();
                        if (2 === this.weekdayBehavior) 0 === r && 0 !== this.weekday && (this.weekday = -6), 0 === this.weekday && 0 !== r && (this.weekday = 7), this.d -= r, this.d += this.weekday;
                        else {
                            var n = this.weekday - r;
                    ...
                    switch (o.setFullYear(this.y, this.m, this.d), o.setHours(this.h, this.i, this.s, this.f), this.firstOrLastDayOfMonth) {
                        case 1:
                            o.setDate(1);
                            break;
                        case -1:
                    ...
                    return isNaN(this.z) || o.getTimezoneOffset() === this.z || (o.setUTCFullYear(o.getFullYear(), o.getMonth(), o.getDate()), o.setUTCHours(o.getHours(), o.getMinutes() + this.z, o.getSeconds(), o.getMilliseconds())), o
                }
            };
        e.exports = function(e, t) {
            null == t && (t = Math.floor(Date.now() / 1e3));
            for (var r = [P.yesterday, P.now, P.noon, P.midnightOrToday, P.tomorrow, P.timestamp, P.firstOrLastDay, P.backOrFrontOf, P.timeTiny12, P.timeShort12, P.timeLong12, P.mssqltime, P.timeShort24, P.timeLong24, P.iso8601long, P.gnuNoColon, P.iso8601noColon, P.americanShort, P.american, P.iso8601date4, P.iso8601dateSlash, P.dateSlash, P.gnuDateShortOrIso8601date2, P.gnuDateShorter, P.dateFull, P.pointedDate4, P.pointedDate2, P.dateNoDay, P.dateNoDayRev, P.dateTextual, P.dateNoYear, P.dateNoYearRev, P.dateNoColon, P.xmlRpc, P.xmlRpcNoColon, P.soap, P.wddx, P.exif, P.pgydotd, P.isoWeekDay, P.pgTextShort, P.pgTextReverse, P.clf, P.year4, P.ago, P.dayText, P.relativeTextWeek, P.relativeText, P.monthFullOrMonthAbbr, P.tzCorrection, P.dateShortWithTimeShort12, P.dateShortWithTimeLong12, P.dateShortWithTimeShort, P.dateShortWithTimeLong, P.relative, P.whitespace], n = Object.create(R); e.length;) {
                for (var o = null, i = null, s = 0, a = r.length; s < a; s++) {
                    var c = r[s],
                        p = e.match(c.regex);
                    p && (!o || p[0].length > o[0].length) && (o = p, i = c)
                }
                if (!i || i.callback && !1 === i.callback.apply(n, o)) return !1;
                e = e.substr(o[0].length), i = null, o = null
            }
            return Math.floor(n.toDate(new Date(1e3 * t)) / 1e3)
        }
    }, function(e, t, r) {
        "use strict";
        e.exports = function(e, t) {
            var r, n, o = ["Sun", "Mon", "Tues", "Wednes", "Thurs", "Fri", "Satur", "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
                i = /\\?(.?)/gi,
                s = function(e, t) {
                    return n[e] ? n[e]() : t
                },
        ...
        e.exports = function(e) {
            e.Templates.registerLoader("ajax", (function(t, r, n, o) {
                ...
                return c.onreadystatechange = function() {
                    var p = null;
                    4 === c.readyState && (200 === c.status || window.cordova && 0 === c.status ? (e.log.debug("Got template ", c.responseText), p = !0 === s ? JSON.parse(c.responseText) : c.responseText, r.url = t, r.data = p, i = a.call(this, r), "function" == typeof n && n(i)) : "function" == typeof o && o(c))
                }, c.open("GET", t, Boolean(r.async)), c.overrideMimeType("text/plain"), c.send(), !!r.async || i
            }))
        }
    }, function(e, t, r) {
        "use strict";
        e.exports = function(e) {
            ...
            e.Templates.registerLoader("fs", (function(r, o, i, s) {
                ...
                var u = function(e, t) {
                    e ? "function" == typeof s && s(e) : (!0 === p && (t = JSON.parse(t)), o.data = t, o.path = o.path || r, a = l.call(this, o), "function" == typeof i && i(a))
                };
                ...
                try {
                    ...
                    throw new e.Error("Unable to find template file " + o.path + ". " + t)
                }
                return c = t.readFileSync(o.path, "utf8"), u(void 0, c), a
            }))
        }
        ...
        function f() {
            l && c && (l = !1, c.length ? p = c.concat(p) : u = -1, p.length && h())
        }
        ...
        o.nextTick = function(e) {
            ...
            p.push(new y(e, t)), 1 !== p.length || l || a(h)
        ...
        e.exports = function(e) {
            for (e.logic = {}, e.logic.type = {
                    ...
                    parse: function(t, r, n) {
                        var o = this;
                        return e.expression.parseAsync.call(o, t.stack, r).then((function(i) {
                            return n = !0, e.lib.boolval(i) ? (n = !1, o.parseAsync(t.output, r)) : ""
                        })).then((function(e) {
                            return {
                                chain: n,
                                output: e
                    ...
                    parse: function(t, r, n) {
                        var o = this;
                        return e.expression.parseAsync.call(o, t.stack, r).then((function(i) {
                            return n && e.lib.boolval(i) ? (n = !1, o.parseAsync(t.output, r)) : ""
                        })).then((function(e) {
                            return {
                                chain: n,
                                output: e
                    ...
                    parse: function(t, r, n) {
                        ...
                        return n && (o = this.parseAsync(t.output, r)), o.then((function(e) {
                            return {
                                chain: n,
                                output: e
                            }
                    ...
                    parse: function(t, r, n) {
                        var o, i, s = [],
                            ...
                            u = function(n, i) {
                                var u = a({}, r);
                                return u[t.valueVar] = i, t.keyVar && (u[t.keyVar] = n), u.loop = function(e, t) {
                                    var n = void 0 !== l;
                                    return {
                                        index: e + 1,
                                        index0: e,
                                ...
                                }(c, o), (void 0 === l ? e.Promise.resolve(!0) : e.expression.parseAsync.call(p, l, u)).then((function(e) {
                                    if (e) return p.parseAsync(t.output, u).then((function(e) {
                                        s.push(e), c += 1
                                    }))
                                })).then((function() {
                                    delete u.loop, delete u[t.valueVar], delete u[t.keyVar], e.merge(r, u, !0)
                                }))
                            };
                        return e.expression.parseAsync.call(p, t.expression, r).then((function(t) {
                            return Array.isArray(t) ? (o = t.length, e.async.forEach(t, (function(e) {
                                return u(c, e)
                            }))) : e.lib.is("Object", t) ? (i = void 0 === t._keys ? Object.keys(t) : t._keys, o = i.length, e.async.forEach(i, (function(e) {
                    ...
                    parse: function(t, r, n) {
                        var o = t.key;
                        return e.expression.parseAsync.call(this, t.expression, r).then((function(e) {
                            return e === r && (e = a({}, e)), r[o] = e, {
                                chain: n,
                                context: r
                            }
                        }))
                    ...
                    parse: function(e, t, r) {
                        var n = this,
                            o = e.key;
                        return n.parseAsync(e.output, t).then((function(e) {
                    ...
                    parse: function(t, r, n) {
                        var o = this;
                        return o.parseAsync(t.output, r).then((function(n) {
                            var i = [{
                                type: e.expression.type.string,
                                value: n
                            }].concat(t.stack);
                    ...
                    compile: function(t) {
                        var r = t.match[1],
                            n = e.expression.compile.call(this, {
                                type: e.expression.type.expression,
                                value: r
                            }).stack;
                        return t.expression = n, delete t.match, t
                    },
                    parse: function(t, r, n) {
                        return e.expression.parseAsync.call(this, t.expression, r).then((function() {
                            return {
                                chain: n,
                                context: r
                            }
                    ...
                    parse: function(t, r, n) {
                        var o = e.Promise.resolve();
                        return this.template.blocks.defined[t.blockName] = new e.Block(this.template, t), (null === this.template.parentTemplate || this.template.parentTemplate instanceof e.Template) && (o = this.getBlock(t.blockName).render(this, r)), o.then((function(e) {
                            return {
                                chain: n,
                                output: e
                            }
                    ...
                    parse: function() {
                        ...
                        return e.logic.handler[e.logic.type.block].parse.apply(t, n)
                    }
                }, {
                    ...
                    parse: function(t, r, n) {
                        var o = this;
                        return e.expression.parseAsync.call(o, t.stack, r).then((function(e) {
                            if (Array.isArray(e)) {
                                var t = e.reverse().reduce((function(e, t) {
                                    try {
                                        return {
                                            render: o.template.importFile(t),
                                            fileName: t
                                        }
                                    } catch (t) {
                                        return e
                                ...
                                null !== t.fileName && (o.template.parentTemplate = t.fileName)
                            } else o.template.parentTemplate = e;
                            return {
                                chain: n,
                                output: ""
                            }
                    ...
                    parse: function(t, r, n) {
                        var o = this;
                        return e.expression.parseAsync.call(o, t.stack, r).then((function(t) {
                            var r = o.template.importFile(t),
                                n = new e.ParseState(r);
                            return n.parseAsync(r.tokens).then((function() {
                                o.template.blocks.imported = a(a({}, o.template.blocks.imported), n.getBlocks())
                            }))
                        })).then((function() {
                            return {
                                chain: n,
                    ...
                    parse: function(t, r, n) {
                        ...
                        return (void 0 === t.withStack ? e.Promise.resolve() : e.expression.parseAsync.call(s, t.withStack, r).then((function(e) {
                            o = a(a({}, o), e)
                        }))).then((function() {
                            return e.expression.parseAsync.call(s, t.stack, r)
                        })).then((function(t) {
                            var r = (Array.isArray(t) ? t : [t]).reduce((function(t, r) {
                                if (null === t.render) {
                                    if (r instanceof e.Template) return {
                                        render: r.renderAsync(o, {
                                            isInclude: !0
                                        }),
                                        lastError: null
                                    };
                                    try {
                                        return {
                                            render: s.template.importFile(r).renderAsync(o, {
                                                isInclude: !0
                                            }),
                                            lastError: null
                                        }
                            ...
                            if (null !== r.render) return r.render;
                            if (null === r.render && i) return "";
                            throw r.lastError
                        })).then((function(e) {
                    ...
                    open: !0,
                    parse: function(t, r, n) {
                        return this.parseAsync(t.output, r).then((function(t) {
                            var r = t.replace(/>\s+</g, "><").trim();
                            return r = new e.Markup(r), {
                                chain: n,
                                output: r
                            }
                        }))
                    ...
                    parse: function(t, r, n) {
                        var o = this;
                        return o.macros[t.macroName] = function() {
                            for (var n = arguments.length, i = new Array(n), s = 0; s < n; s++) i[s] = arguments[s];
                            var c = a(a({}, r), {}, {
                                _self: o.macros
                            });
                            return e.async.forEach(t.parameters, (function(n, o) {
                                return void 0 !== i[o] ? (c[n] = i[o], !0) : void 0 !== t.defaults[n] ? e.expression.parseAsync.call(this, t.defaults[n], r).then((function(t) {
                                    return c[n] = t, e.Promise.resolve()
                                })) : (c[n] = void 0, !0)
                            })).then((function() {
                                return o.parseAsync(t.output, c)
                            }))
                        }, {
                            chain: n,
                            output: ""
                    ...
                    parse: function(t, r, n) {
                        ...
                        return "_self" === t.expression ? (r[t.contextName] = o.macros, i) : e.expression.parseAsync.call(o, t.stack, r).then((function(e) {
                            return o.template.importFile(e || t.expression)
                        })).then((function(n) {
                            var o = new e.ParseState(n);
                            return o.parseAsync(n.tokens).then((function() {
                                return r[t.contextName] = o.macros, i
                            }))
                        }))
                    }
                }, {
                    ...
                    open: !0,
                    compile: function(t) {
                        var r, n = t.match[1].trim(),
                            i = {},
                            s = o(t.match[2].trim().split(/\s*,\s*/));
                        try {
                            for (s.s(); !(r = s.n()).done;) {
                                var a = r.value,
                        ...
                        return delete t.match, t.expression = n, t.macroNames = i, t.stack = e.expression.compile.call(this, {
                            type: e.expression.type.expression,
                            value: n
                        }).stack, t
                    },
                    parse: function(t, r, n) {
                        var o = this;
                        return ("_self" === t.expression ? e.Promise.resolve(o.macros) : e.expression.parseAsync.call(o, t.stack, r).then((function(e) {
                            return o.template.importFile(e || t.expression)
                        })).then((function(t) {
                            var r = new e.ParseState(t);
                            return r.parseAsync(t.tokens).then((function() {
                                return r.macros
                            }))
                        }))).then((function(e) {
                            for (var o in t.macroNames) void 0 !== e[o] && (r[t.macroNames[o]] = e[o]);
                            return {
                                chain: n,
                                output: ""
                            }
                    ...
                    parse: function(t, r, n) {
                        var o = {},
                            i = e.Promise.resolve(),
                            s = this;
                        return t.only || (o = a({}, r)), void 0 !== t.withStack && (i = e.expression.parseAsync.call(s, t.withStack, r).then((function(e) {
                            o = a(a({}, o), e)
                        }))), i.then((function() {
                            return e.expression.parseAsync.call(s, t.stack, o)
                        })).then((function(r) {
                            ...
                            return n.parentTemplate = r, n.renderAsync(o, {
                                isInclude: !0
                            })
                        })).then((function(e) {
                            return {
                    ...
                    parse: function(t, r, n) {
                        var o, i = {},
                            s = this,
                            c = e.Promise.resolve();
                        return t.only || (i = a({}, r)), void 0 !== t.withStack && (c = e.expression.parseAsync.call(s, t.withStack, r).then((function(e) {
                            for (o in e) Object.hasOwnProperty.call(e, o) && (i[o] = e[o])
                        }))), c.then((function() {
            ...
            return e.logic.compile = function(t) {
                ...
                for (r in t = t.trim(), e.logic.handler)
                    if (Object.hasOwnProperty.call(e.logic.handler, r))
                        for (n = e.logic.handler[r].type, i = o = e.logic.handler[r].regex, Array.isArray(o) || (i = [o]), s = i.length, a = 0; a < s; a++)
                            if (null !== (c = i[a].exec(t))) return e.log.trace("Twig.logic.tokenize: ", "Matched a ", n, " regular expression of ", c), {
                                type: n,
                                match: c
                            };
                ...
                return e.async.potentiallyAsync(this, o, (function() {
                    ...
                    var o, i = e.logic.handler[t.type],
                        s = this;
                    return i.parse ? (s.nestingStack.unshift(t), o = i.parse.call(s, t, r || {}, n), e.isPromise(o) ? o = o.then((function(e) {
                        return s.nestingStack.shift(), e
                    })) : s.nestingStack.shift(), o) : ""
                }))
            }, e
        }
    }, function(e, t, r) {
        ...
        e.exports = function(e) {
            return e.path = {}, e.path.parsePath = function(t, r) {
                ...
                var o, i, s, a = "/",
                    c = [],
                    p = n || "";
                if (t.url) o = void 0 === t.base ? t.url : t.base.replace(/([^/])$/, "$1/");
                else if (t.path) {
                    var l = r(6),
                        u = l.sep || a,
                        f = new RegExp("^\\.{1,2}" + u.replace("\\", "\\\\"));
                    p = p.replace(/\//g, u), void 0 !== t.base && null === p.match(f) ? (p = p.replace(t.base, ""), o = t.base + u) : o = l.normalize(t.path), o = o.replace(u + u, u), a = u
                } else {
                    if (!t.name && !t.id || !t.method || "fs" === t.method || "ajax" === t.method) throw new e.Error("Cannot extend an inline template.");
                    o = t.base || t.name || t.id
                }
                for ((i = o.split(a)).pop(), i = i.concat(p.split(a)); i.length > 0;) "." === (s = i.shift()) || (".." === s && c.length > 0 && ".." !== c[c.length - 1] ? c.pop() : c.push(s));
                return c.join(a)
            }, e
        }
    }, function(e, t, r) {
        ...
        e.exports = function(e) {
            return e.ParseState.prototype.parseAsync = function(e, t) {
                ...
                return function(e, t, r) {
                    ...
                    o(2, e)
                })), 1 === r ? e.Promise.resolve(n) : 2 === r ? e.Promise.reject(n) : (o = new e.FullPromise).promise
                ...
                function i(e, i) {
                    if (!s._state && (s._value = i, s._state = e, o = 1 === e ? r : n, t)) {
                        if (-2 === t[2]) return o(t[0], t[1]), void(t = null);
                        t.forEach((function(e) {
                            o(e[0], e[1])
                        })), t = null
                    }
                }
                var s = new e.Thenable((function(t, r) {
                    var n = "function" == typeof t;
                    if (1 === s._state && !n) return e.Promise.resolve(s._value);
                    if (1 === s._state) try {
                ...
                return e.async.forEach(t, (function(t, n) {
                    if (e.isPromise(t)) {
                ...
                return function i() {
                    var s = null;
                    do {
                        if (o === n) return e.Promise.resolve();
                        s = r(t[o], o), o++
            ...
            return e.exports = {
                ...
                var o = (r = r || {}).settings || {},
                    ...
                    s = {
                        ...
                        base: o.views,
                        load: function(e) {
                            i && i.allowAsync ? e.renderAsync(r).then((function(e) {
                                return n(null, e)
                            }), n) : n(null, String(e.render(r)))
                        },
                        error: function(e) {
                            n(e)
                        }
